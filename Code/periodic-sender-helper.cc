...
void
PeriodicSenderHelper::SetNetworkkey (std::string nwkkey)
{
  m_nwkkkey = nwkkey;
  NS_LOG_DEBUG("NWKKEY IN PERIODIC HELPER "<< m_nwkkkey);
}
void
...
void
PeriodicSenderHelper::SetPayload (uint8_t const *buffer)
{
  m_pktbuff = buffer;
